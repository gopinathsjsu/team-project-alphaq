...
export default function ShareButton({ shareUrl, title, description, tags }) {
  const [show, setShow] = useState(false);
  return (
    <React.Fragment>
      <motion.button
        className="text-beta bg-white shadow border border-solid  hover:bg-beta hover:text-white
             active:bg-blue-600 font-bold uppercase text-xs px-4 py-2 rounded-full outline-none
